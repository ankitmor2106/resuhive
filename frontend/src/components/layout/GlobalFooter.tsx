      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              <span className="font-serif font-bold text-lg tracking-tight text-ink">ResuHive<span className="text-pine">.</span></span>
            </Link>
        ...
        <div className="border-t border-border/40 pt-8 flex flex-col md:flex-row justify-center items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} ResuHive. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
